...
class Ui_DialogExport(object):
    def setupUi(self, DialogExport):
        ...
        sizePolicy.setHeightForWidth(self.lineEdit_ExportFolder.sizePolicy().hasHeightForWidth())
        self.lineEdit_ExportFolder.setSizePolicy(sizePolicy)
        ...
        sizePolicy1.setHeightForWidth(self.comboBox_ExportFormat.sizePolicy().hasHeightForWidth())
        self.comboBox_ExportFormat.setSizePolicy(sizePolicy1)

        self.gridLayout.addWidget(self.comboBox_ExportFormat, 4, 1, 1, 1)
        ...
        self.label_FileType = QLabel(DialogExport)
        self.label_FileType.setObjectName(u"label_FileType")
        self.label_FileType.setAlignment(Qt.AlignRight|Qt.AlignTrailing|Qt.AlignVCenter)

        self.gridLayout.addWidget(self.label_FileType, 3, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.pushButton_OK, 5, 1, 1, 1)

        self.comboBox_ExportFileType = QComboBox(DialogExport)
        self.comboBox_ExportFileType.addItem("")
        self.comboBox_ExportFileType.addItem("")
        self.comboBox_ExportFileType.setObjectName(u"comboBox_ExportFileType")
        sizePolicy1.setHeightForWidth(self.comboBox_ExportFileType.sizePolicy().hasHeightForWidth())
        self.comboBox_ExportFileType.setSizePolicy(sizePolicy1)

        self.gridLayout.addWidget(self.comboBox_ExportFileType, 3, 1, 1, 1)
    ...
    def retranslateUi(self, DialogExport):
        ...
        self.label_FileType.setText(QCoreApplication.translate("DialogExport", u"File Type:", None))
        self.pushButton_OK.setText(QCoreApplication.translate("DialogExport", u"Export", None))
        self.comboBox_ExportFileType.setItemText(0, QCoreApplication.translate("DialogExport", u"XLSX", None))
        self.comboBox_ExportFileType.setItemText(1, QCoreApplication.translate("DialogExport", u"HDF5", None))
